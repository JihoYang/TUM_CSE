function [val,err,nfcn] = AdaptiveGaussQuadrature(f,interval,TOL,m,nograph)
...
%
% idea following E. Hairer, Introduction � l'Analyse Num�rique, 
%     Universit� de Gen�ve, 2001, S. 17-18
%
...
%               nograph     flag for doing no graphics
%

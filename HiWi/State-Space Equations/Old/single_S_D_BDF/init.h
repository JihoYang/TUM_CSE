...
int read_parameters( 
  ...
  double *dt,
  double *g,
  double *springFreeLength);


int write_output( char* outFileName, std::vector<double> time, std::vector<double> disp,
					std::vector<double> vel, std::vector<double> acc, std::vector<double> force, double stepHeight );

/*-----------------------------------------------------------------------------*/
/*                                                                             */
/*  2nd order BDF solver for State Space systems                               */                                                                                                
/*                                                                             */
...
int main(int argn, char **args){   
    ...
    int itermax = 5000;       /*Maximum number of Newton iteration*/
    int i;
    ...
    /*Initialise matrices*/
    init_matrix(x, 0, dof * 2 - 1, 0, t_end / dt, 2);
    ...
    /*2nd order BDF*/
    bdf(x, u, A, B, t_end, dt, itermax, dof);

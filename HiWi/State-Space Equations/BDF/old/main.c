...
int main(int argn, char **args){   
    ...
    /*4th order backward difference formula*/
    bdf(x, u, A, B, t_end, dt, itermax, num_body);

    /*Export results*/
    export_result("BDF", t_end, dt, x);

    /*Free memory allocation*/
    free_matrix(x, 0, num_body * 2 - 1, 0, t_end / dt + 1);
